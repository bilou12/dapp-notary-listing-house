...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Caller should be the owner.");
        _;
    }
...
contract Pausable is Ownable {
    ...
    function _setPaused(bool _newStatus) internal {
        bool oldStatus = _paused;
        _paused = _newStatus;
    ...
    function setPaused(bool _newStatus) public onlyOwner {
        _setPaused(_newStatus);
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != ownerOf(tokenId),
            "The address 'to' is the owner of tokenId."
        );
